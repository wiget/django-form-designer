...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinitionField.placeholder'
        db.add_column('form_designer_formdefinitionfield', 'placeholder',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormDefinitionField.placeholder'
        db.delete_column('form_designer_formdefinitionfield', 'placeholder')
    ...
    models = {
        ...
        'form_designer.formdefinitionfield': {
            ...
            'placeholder': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
