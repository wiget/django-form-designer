...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FormDefinition.success_message'
        db.alter_column('form_designer_formdefinition', 'success_message', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Changing field 'FormDefinition.error_message'
        db.alter_column('form_designer_formdefinition', 'error_message', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'FormDefinition.success_message'
        db.alter_column('form_designer_formdefinition', 'success_message', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'FormDefinition.error_message'
        db.alter_column('form_designer_formdefinition', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'error_message': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'success_message': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
